...
{
	public class GoldCoin : ItemBase
	{
		...
		public GoldCoin() { }
		public override void Awake() => Initialize(this.GetComponent<SpriteRenderer>(), this.GetComponent<Animator>(), CurrencyItemType.Goldcoin);
		...
		public override void Initialize(SpriteRenderer spriteRenderer, Animator animator, CurrencyItemType currencyItemType)
		{
			...
			_itemAnimator = new ItemAnimator(animator, "ItemAnimControllers", "Currency", "Currency", CurrencyItemType.Goldcoin);
