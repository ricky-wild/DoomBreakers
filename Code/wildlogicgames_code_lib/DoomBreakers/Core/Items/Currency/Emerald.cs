...
namespace DoomBreakers
{
	public class Emerald : ItemBase
	{
		...
		public Emerald() { }
		public override void Awake() => Initialize(this.GetComponent<SpriteRenderer>(), this.GetComponent<Animator>(), CurrencyItemType.Emerald);
		...
		public override void Initialize(SpriteRenderer spriteRenderer, Animator animator, CurrencyItemType currencyItemType)
		{
			...
			_itemAnimator = new ItemAnimator(animator, "ItemAnimControllers", "Currency", "Currency", CurrencyItemType.Emerald);
