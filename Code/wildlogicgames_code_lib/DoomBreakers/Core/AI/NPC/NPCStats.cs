...
{
	public class NPCStats : CharacterStat
	{
		...
		public NPCStats(double h, double s, double d) : base(health: h, stamina: s, defence: d)
		{
		}
		public NPCStats(ref Transform[] healthTransforms, ref Transform[] bleedTransforms, ref Transform[] bludgeonTransforms, double h, double s, double d) : base(health: h, stamina: s, defence: d)
		{
