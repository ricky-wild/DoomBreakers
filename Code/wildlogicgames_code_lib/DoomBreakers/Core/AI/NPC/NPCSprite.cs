...
{
	public class NPCSprite : Sprite
	{
        private SpriteColourIndex _spriteColourIndex;
        private int _npcID, _spriteFaceDirection;
        private ITimer _colorSwappedTimer;
        private bool _colorSwappedFlag;

        private ITimer _behaviourTimer;

        public void Setup(SpriteRenderer spriteRenderer, int npcID)
        {
        ...
        {
            SetupTexture2DColorSwap("_SwapTexBandit", _npcID);
        ...
        void Update() => UpdateColorTextureResetInternally();
